...
cc.Class({
    ...
    addHandCard:function(Card,bGet)
    {
        ...
        else
        {
            ...
            cc.log("Card_Hand anchorX={0} anchorY={0}",Card_Hand.anchorX,Card_Hand.anchorY);
            //Card_Hand.anchorX = 0.5;
            //Card_Hand.anchorY = 1.0;
            CardNodeJs.ChangeCardFrameByCardData_Hand(this.m_ChairID,Card);
            this.m_Card_Hand.push(Card_Hand);
            if( this.m_HandCardParentNode1.childrenCount <= 9 )
            {
