...
cc.Class({
    ...
    init: function (data, ruleflag) {
        ...
        var rule = this.node.addComponent('bzRule');
        SssManager.rule = rule;
        SssManager.soundCtrl = this.node.addComponent('bzSound');
    },
